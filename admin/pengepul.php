<?php
    ...
    if (isset($_POST['delete'])){
        ...
        echo "<script>alert('Berhasil')
                window.location.href = 'pengepul.php';
                </script>";
    }

    $result = mysqli_query($conn, "SELECT*from admin where username='$username'");

    $result2 = mysqli_query($conn, "SELECT*from pengepul");
...
<head>
    <meta charset="UTF-8">
    <title>Tresaikel - Data Pengepul</title>
    ...
    <p>(Admin)</p>
       ...
       <div class="container">
        ...
        while($row = mysqli_fetch_array($result2)) {         
            ...
            echo "<td><a class='pilih' href='edit_pengepul.php?user=$row[username]'>Edit</a></td>";
