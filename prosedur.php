...
<head>
    ...
    <title>Tresaikel - Prosedur Penukaran Sampah</title>
</head>
...
<nav>
    ...
    <p><?php
       ...
       <li class="active"><a href="prosedur.php">
    ...
    <li><a href="dashboard.php">
       ...
       <li><a href="jenhar.php">
       <i class="fas fa-cart-arrow-down"></i>
           <span class="nav-item">Jenis & Harga</span>
       </a></li>
    ...
    ?> 
       ...
       <center><img src="img/prose.png" style="width: 75%; align: center;" alt="Trash"></center>
        </div>
    <div class="mainn">
    <div class="topnav">
